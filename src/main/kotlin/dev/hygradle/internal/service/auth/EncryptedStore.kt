...
// * `com.hypixel.hytale.server.core.auth.EncryptedAuthCredentialStore`, using the Gradle project
// name
// * instead of the hardware UUID. This results in the same threat model as the Hytale server - if
// one
